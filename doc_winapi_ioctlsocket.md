...
ioctlsocket 我会放在 Socket 生命周期、选项、地址转换和异步网络事件 时查。先做最小调用，把返回值、错误码和调用上下文写清楚，再放回具体样本或现场里判断。
...
```powershell
dumpbin /exports C:\Windows\System32\ws2_32.dll | findstr /i ioctlsocket
```
